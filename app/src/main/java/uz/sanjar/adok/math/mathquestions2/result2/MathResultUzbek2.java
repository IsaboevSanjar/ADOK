...
import uz.sanjar.adok.math.mathquestions2.MathActivityUzbek2;
import uz.sanjar.adok.start.StartActivityUzbek;

public class MathResultUzbek2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_result_uzbek2);
        ...
        if (mistakes >= 1) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(MathResultUzbek2.this, MathActivityUzbek2.class);
    ...
    public void showAlert() {
        ...
        builder.setTitle("Uzur\uD83D\uDE15")
                .setMessage("Bizda matematikadan boshqa savol yo'q \uD83D\uDE15.\n" +
        ...
        builder.setPositiveButton("Tugatish", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(MathResultUzbek2.this, StartActivityUzbek.class);
                startActivity(intent);
                finish();
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MathResultUzbek2.this, StartActivityUzbek.class));
        finish();
    }
