...
public class MathResultUz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_result_uz);
        ...
        if (trues < 46) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(MathResultUz.this, MathActivityUzbek.class);
            ...
            textViewNextStep.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MathResultUz.this, MathActivityUzbek2.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MathResultUz.this, StartActivityUzbek.class));
        finish();
    }
