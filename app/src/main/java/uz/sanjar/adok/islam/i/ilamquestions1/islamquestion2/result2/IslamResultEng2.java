...
public class IslamResultEng2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_islam_result_eng2);
        ...
        if (trues <= 17) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(IslamResultEng2.this, IslamEnglishActivity2.class);
    ...
    public void showAlert() {
        ...
        builder.setTitle("Sorry\uD83D\uDE15")
                .setMessage("Now we don't have other questions from Islam \uD83D\uDE15." +
        ...
        builder.setPositiveButton("Finish", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(IslamResultEng2.this, StartActivityEnglish.class);
                startActivity(intent);
                finish();
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(IslamResultEng2.this, StartActivityEnglish.class));
        finish();
    }
