...
public class IslamResultUz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_islam_result_uz);
        ...
        if (trues < 46) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(IslamResultUz.this, IslamUzbekActivity.class);
            ...
            textViewNextStep.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(IslamResultUz.this, IslamUzbekActivity2.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(IslamResultUz.this, StartActivityUzbek.class));
        finish();
    }
