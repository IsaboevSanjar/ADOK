...
import uz.sanjar.adok.math.mathquestions2.result2.MathResultEng2;
import uz.sanjar.adok.start.StartActivityEnglish;

public class MathActivityEng2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_eng2);
        startTimer();
        loadViews();
        setStateViews();
        loadData();
    ...
    private void setListener() {
        resultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putInt(MathResultEng2.KEY_TRUES, trueCount);
                bundle.putString(MathResultEng2.KEY_TYPE, key);
                bundle.putInt(MathResultEng2.KEY_MISTAKES, falseCount);

                Intent intent = new Intent(MathActivityEng2.this, MathResultEng2.class);
        ...
        if (mTimerRunning) {
                ...
                public void onClick(View view) {
                    ...
                    if (isFinished) {
                        ...
                        if (hasPressed) {
                            ...
                            Toast.makeText(MathActivityEng2.this, "Choose the answer!!!", Toast.LENGTH_SHORT).show();
                        }
            ...
            comeBack.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MathActivityEng2.this, StartActivityEnglish.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MathActivityEng2.this, StartActivityEnglish.class));
        finish();
    }
}