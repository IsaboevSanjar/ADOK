...
import uz.sanjar.adok.geo.geoquestions1.r.geoquestions2.GeoEnglishActivity2;
import uz.sanjar.adok.start.StartActivityEnglish;

public class GeoResultEng2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_result_eng2);
        ...
        if (mistakes >= 1) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(GeoResultEng2.this, GeoEnglishActivity2.class);
    ...
    public void showAlert() {
        ...
        builder.setTitle("Sorry\uD83D\uDE15")
                .setMessage("Now we don't have other questions from geography \uD83D\uDE15. " +
        ...
        builder.setPositiveButton("Finish", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(GeoResultEng2.this, StartActivityEnglish.class);
                startActivity(intent);
                finish();
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GeoResultEng2.this, StartActivityEnglish.class));
        finish();
    }
