package uz.sanjar.adok.math.mathquestions2;
...
import uz.sanjar.adok.math.mathquestions2.result2.MathResultUzbek2;
import uz.sanjar.adok.start.StartActivityUzbek;

public class MathActivityUzbek2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_uzbek2);
        startTimer();
        loadViews();
        setStateViews();
        loadData();
    ...
    private void setListener() {
        resultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putInt(MathResultUzbek2.KEY_TRUES, trueCount);
                bundle.putString(MathResultUzbek2.KEY_TYPE, key);
                bundle.putInt(MathResultUzbek2.KEY_MISTAKES, falseCount);

                Intent intent = new Intent(MathActivityUzbek2.this, MathResultUzbek2.class);
        ...
        if (mTimerRunning) {
                ...
                public void onClick(View view) {
                    ...
                    if (isFinished) {
                        ...
                        if (hasPressed) {
                            ...
                            Toast.makeText(MathActivityUzbek2.this, "Javobni tanlang!!!", Toast.LENGTH_SHORT).show();
                        }
            ...
            comeBack.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MathActivityUzbek2.this, StartActivityUzbek.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MathActivityUzbek2.this, StartActivityUzbek.class));
        finish();
    }
}