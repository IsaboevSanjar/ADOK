...
public class GeoResultUz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_result_uz);
        ...
        if (trues < 46) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(GeoResultUz.this, GeoUzbekActivity.class);
            ...
            textViewNextStep.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(GeoResultUz.this, GeoUzbekActivity2.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GeoResultUz.this, StartActivityUzbek.class));
        finish();
    }
