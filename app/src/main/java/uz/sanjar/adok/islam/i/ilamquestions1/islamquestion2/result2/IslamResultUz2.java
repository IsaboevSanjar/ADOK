package uz.sanjar.adok.islam.i.ilamquestions1.islamquestion2.result2;
...
import uz.sanjar.adok.islam.i.ilamquestions1.islamquestion2.IslamUzbekActivity2;
import uz.sanjar.adok.start.StartActivityUzbek;

public class IslamResultUz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_islam_result_uz2);
        ...
        if (trues < 47) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(IslamResultUz2.this, IslamUzbekActivity2.class);
    ...
    public void showAlert() {
        ...
        builder.setTitle("Uzur\uD83D\uDE15")
                .setMessage("Bizda Islom dini bo'yicha boshqa savollar yo'q \uD83D\uDE15. " +
        ...
        builder.setPositiveButton("Tugatish", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(IslamResultUz2.this, StartActivityUzbek.class);
                startActivity(intent);
                finish();
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(IslamResultUz2.this, StartActivityUzbek.class));
        finish();
    }
