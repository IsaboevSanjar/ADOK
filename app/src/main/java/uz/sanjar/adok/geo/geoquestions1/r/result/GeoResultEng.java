package uz.sanjar.adok.geo.geoquestions1.r.result;
...
public class GeoResultEng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_result_eng);
        ...
        if (trues < 46) {
            ...
            textViewTryAgain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(GeoResultEng.this, GeoEnglishActivity.class);
            ...
            textViewNextStep.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(GeoResultEng.this, GeoEnglishActivity2.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GeoResultEng.this, StartActivityEnglish.class));
        finish();
    }
