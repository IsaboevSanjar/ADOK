...
import uz.sanjar.adok.geo.geoquestions1.r.geoquestions2.result2.GeoResultEng2;
import uz.sanjar.adok.start.StartActivityEnglish;

public class GeoEnglishActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_english2);
        startTimer();
        loadViews();
        setStateViews();
        loadData();
    ...
    private void setListener() {
        resultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putInt(GeoResultEng2.KEY_TRUES, trueCount);
                bundle.putString(GeoResultEng2.KEY_TYPE, key);
                bundle.putInt(GeoResultEng2.KEY_MISTAKES, falseCount);

                Intent intent = new Intent(GeoEnglishActivity2.this, GeoResultEng2.class);
        ...
        if (mTimerRunning) {
                ...
                public void onClick(View view) {
                    ...
                    if (isFinished) {
                        ...
                        if (hasPressed) {
                            ...
                            Toast.makeText(GeoEnglishActivity2.this, "Choose the answer!!!", Toast.LENGTH_SHORT).show();
                        }
            ...
            comeBack.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(GeoEnglishActivity2.this, StartActivityEnglish.class);
                    startActivity(intent);
                    finish();
                }
            });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GeoEnglishActivity2.this, StartActivityEnglish.class));
        finish();
    }
}